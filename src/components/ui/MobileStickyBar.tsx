  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50">
      <div className="bg-white border-t border-[#E8EDF5] px-4 sm:px-8 py-3 flex items-center justify-between gap-4 shadow-[0_-2px_12px_rgba(0,0,0,0.06)]">
        ...
        <a href="/clearance/onboarding" onClick={() => track('cta_click', 'sticky_bar')}
          className="shrink-0 bg-[#0C1525] text-white text-xs font-semibold px-5 py-2.5 rounded-sm hover:bg-[#152238] transition-colors">
          {t('sticky.button')}
        </a>
      </div>
    </div>
