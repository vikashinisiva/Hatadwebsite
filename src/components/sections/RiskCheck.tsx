...
import { Search, Lock, ShieldAlert, FileSearch, Scale, MapPin, AlertTriangle, CheckCircle } from 'lucide-react'
...
export function RiskCheck() {
  ...
  function handleCheck() {
    ...
    // Basic format check — must contain at least one digit and look like a survey number
        ...
        >
          <div className="text-center mb-12">
            ...
            <motion.p variants={fadeInUp} className="text-lg text-text-secondary font-light max-w-xl mx-auto">
              Enter your survey number. See what our system finds before you commit.
            </motion.p>
            ...
            >
              {[
                '6 government sources checked',
                'Cross-referenced in under 3 hours',
                'Tamil Nadu\u2019s most thorough check',
              ].map((text) => (
                <span
                  key={text}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0D1B2A]/[0.04] border border-[#0D1B2A]/[0.08] text-[11px] text-text-muted font-medium"
                >
                ...
                >
                  <div className="bg-white border border-border rounded-sm p-6 sm:p-8 shadow-[0_2px_20px_rgba(0,0,0,0.04)]">
                    <div className="space-y-4">
                      <div>
                        <label className="block text-xs font-medium text-text-secondary tracking-wide mb-2">
                          Survey / Patta Number
                        </label>
                        <input
                          type="text"
                    ...
                    <p className="text-center text-[10px] text-text-muted mt-4">
                      Free instant check. No sign-up required.
                    </p>
                  </div>
                </motion.div>
              )}
                  ...
                  <div className="bg-white border border-border rounded-sm p-8 sm:p-10 shadow-[0_2px_20px_rgba(0,0,0,0.04)]">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-text-primary font-semibold">
                        Scanning records for {surveyNo}, {district}
                      </p>
                    </div>
                      ...
                      {[
                        ...
                        >
                          <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            transition={{ delay: step.delay + 0.6, duration: 0.2 }}
                          >
                  ...
                  <div className="bg-white border border-border rounded-sm overflow-hidden shadow-[0_2px_20px_rgba(0,0,0,0.04)]">
                    ...
                    <div className="bg-[#0D1B2A] px-6 sm:px-8 py-5">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-[#C9A84C] text-[10px] font-medium tracking-[0.15em] uppercase">
                            Property Risk Preview
                          </p>
                        ...
                        <div className="flex items-center gap-2 bg-white/10 rounded-sm px-3 py-1.5">
                          ...
                          <span className="text-[11px] text-white/80 font-medium">Sources available</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-6 sm:p-8">
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-white/60 backdrop-blur-[2px] flex flex-col items-center justify-center">
                          ...
                          <p className="text-sm font-semibold text-text-primary mb-1">Risk Score Locked</p>
                          <p className="text-xs text-text-muted">Full analysis requires document retrieval across 6 sources</p>
                        </div>
                      </motion.div>
                      ...
                      <div className="flex items-start gap-2.5 bg-amber-50 border border-amber-200/60 rounded-sm px-4 py-3 mb-6">
                        ...
                        <p className="text-xs text-amber-800 leading-relaxed">
                          Government records are available for properties in {district}. A full clearance report will retrieve
                          and cross-reference all 6 sources to flag contradictions, encumbrances, or litigation specific to your survey number.
                        </p>
                      </div>

                      {/* CTA */}
                      <a href="/clearance" className="block">
                      ...
                      <button
                        onClick={handleReset}
                        className="block mx-auto mt-4 text-xs text-text-muted hover:text-accent-blue transition-colors cursor-pointer"
                      >
